...
/*
    Uncomment this class when you are ready to sun your UriMatcher.  Note that this class utilizes
    constants that are declared with package protection inside of the UriMatcher, which is why
    the sun must be in the same data package as the Android app code.  Doing the sun this way is
