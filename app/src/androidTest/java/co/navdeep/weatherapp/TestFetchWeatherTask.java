...
public class TestFetchWeatherTask extends AndroidTestCase {
    ...
    private class FetchWeatherTask{
        ...
        public long addLocation(String locationSetting, String cityName, double lat, double lon){
            return DbUtilities.insertLocationRowInDb(new LocationRow(locationSetting, cityName, lon, lat), mContext);
        }
    }
    /*
        Students: uncomment testAddLocation after you have written the AddLocation function.
        This sun will only run on API level 11 and higher because of a requirement in the
        content provider.
     */
    @TargetApi(11)
    public void testAddLocation() {
        ...
        // clean up the sun so that other tests can use the content provider
