...
/**
 * Manages "Authentication" to app's backend service.  The SyncAdapter framework
 ...
 */
public class WeatherAppAuthenticator extends AbstractAccountAuthenticator {
    public WeatherAppAuthenticator(Context context) {
        super(context);
    }
